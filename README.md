...
1. **Wie wird der Einsatz in Köln organisiert?** Eigener Fahrer, Partner, Standort? Die Antwort gehört in die FAQ („Wo sitzt Faster, und wer fährt in Köln?“, gelb markiert). Ohne belastbare Antwort sollte die Seite nicht online gehen.
...
3. **Impressum** (§ 5 DDG): Firmenname/Rechtsform, Unternehmensnummer (KBO), USt-IdNr., Vertretungsberechtigter. Diese Angaben sind nirgends veröffentlicht und gelb markiert.
